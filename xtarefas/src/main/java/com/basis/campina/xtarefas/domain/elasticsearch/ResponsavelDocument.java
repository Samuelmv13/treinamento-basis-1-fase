...
public class ResponsavelDocument extends BaseDocument{
    ...
    public ResponsavelDocument(Integer id, String nome, String email, LocalDate dataNascimento, String tarefas){
        this.id = id;
        this.nome = nome;
        this.email = email;
        this.dataNascimento = dataNascimento != null ?
                LocalDate.parse(dataNascimento.format(DateTimeFormatter.ofPattern(DATE_PATTERN))) : null;
